...
parser.add_argument("-oa", "--outputa", default="plots/jaccard_best_pc.pdf")
parser.add_argument("-ob", "--outputb", default="plots/jaccard_first_pc.pdf")
parser.add_argument("-oc", "--outputc", default="plots/best_pc_jaccard.pdf")
parser.add_argument("-od", "--outputd", default="plots/first_pc_jaccard.pdf")
parser.add_argument("-otd", "--onttabledir", default="/home/fnargesian/WIKI_TABLE/onttables")
parser.add_argument("-oe", "--outpute", default="plots/first_vs_best.pdf")
parser.add_argument("-of", "--outputf", default="plots/best_vs_first.pdf")
...
plt.title('ontology jaccard vs best pc cosine of column pairs', fontsize=24)
...
plt.title('best pc cosine vs ontology jaccard of column pairs', fontsize=24)
...
plt.title('first pc cosine vs best pc cosine (number of pcs = 3) of column pairs', fontsize=24)
...
plt.ylabel('nearest pc cosine', fontsize=24)
plt.xlabel('best pc cosine', fontsize=24)
plt.title('best pc cosine (number of pcs = 3) vs first pc cosine of column pairs', fontsize=24)
