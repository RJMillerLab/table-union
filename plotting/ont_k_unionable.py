...
for table_id1, table_id2 in cursor2.execute("select distinct table_id1, table_id2 from allscores;").fetchall():
...
for table_id1, table_id2 in \
    ...
    for column_index1, column_index2 in \
        cursor2.execute("select column_index1, column_index2 from allscores where table_id1 = ? and table_id2 = ? and sarma > ?;", (table_id1, table_id2, ontology_threshold)).fetchall():   
